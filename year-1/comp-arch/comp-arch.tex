...
And so on. Clearly they're just two of the previous hyper cube placed next
to each other.

Ideally, we want topologies where the latency scales up logarithmically
because we don't want it to take ages for the solution to get to the
computer. The most common type is the CNN looking network.
